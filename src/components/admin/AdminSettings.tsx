          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-255 p-6 md:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" value={homeSettings.hero.label} onChange={e => updateHomeSettings({...homeSettings, hero: {...homeSettings.hero, label: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" value={homeSettings.hero.titleMain} onChange={e => updateHomeSettings({...homeSettings, hero: {...homeSettings.hero, titleMain: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Título Destacado (Texto Gradiente)</label>
                <input type="text" value={homeSettings.hero.titleHighlight} onChange={e => updateHomeSettings({...homeSettings, hero: {...homeSettings.hero, titleHighlight: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm" />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-bold text-gray-700 mb-2">Descripción</label>
                <textarea rows={2} value={homeSettings.hero.description} onChange={e => updateHomeSettings({...homeSettings, hero: {...homeSettings.hero, description: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm"></textarea>
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Botón Primario</label>
                <input type="text" value={homeSettings.hero.ctaPrimary} onChange={e => updateHomeSettings({...homeSettings, hero: {...homeSettings.hero, ctaPrimary: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Botón Secundario</label>
                <input type="text" value={homeSettings.hero.ctaSecondary} onChange={e => updateHomeSettings({...homeSettings, hero: {...homeSettings.hero, ctaSecondary: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-255 p-6 md:col-span-2">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div>
                ...
                <input type="text" value={homeSettings.cta?.title || ""} onChange={e => updateHomeSettings({...homeSettings, cta: {...homeSettings.cta, title: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Descripción</label>
                <textarea rows={2} value={homeSettings.cta?.description || ""} onChange={e => updateHomeSettings({...homeSettings, cta: {...homeSettings.cta, description: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm"></textarea>
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">Texto del Botón</label>
                <input type="text" value={homeSettings.cta?.buttonText || ""} onChange={e => updateHomeSettings({...homeSettings, cta: {...homeSettings.cta, buttonText: e.target.value}})} className="w-full border border-gray-300 rounded-lg p-2.5 text-sm" />
              </div>
            </div>
          </div>
        </div>
